...
metadata = {
    ...
    'author': 'Aitor Gastaminza & José Luis Villanueva (jlvillanueva@clinic.cat) & Alex Gasulla',
    'source': 'Hospital Clínic Barcelona & HU Vall Hebrón',
    'apiLevel': '2.0',
    'description': 'Protocol for RNA extraction using OMEGA commercial kit'
}
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    Lysis = Reagent(name = 'Lysis',
                    ...
                    rinse = True,
                    reagent_reservoir_volume = 50700,
    ...
    VHB = Reagent(name = 'VHB',
                    ...
                    flow_rate_dispense = 1,
                    rinse = True,
                    reagent_reservoir_volume = 67200,
                    num_wells = 5, #num_Wells max is 5
                    h_cono = 1.95,
                    v_fondo = 1.95*multi_well_rack_area/2, #Prismatic
                    tip_recycling = 'A1')
