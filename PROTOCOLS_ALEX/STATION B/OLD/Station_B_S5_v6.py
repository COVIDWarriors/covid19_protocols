...
def run(ctx: protocol_api.ProtocolContext):
    ...
    STEPS = { #Dictionary with STEP activation, description, and times
            ...
            4:{'Execute': False, 'description': 'Incubate wait with magnet ON', 'wait_time': 300}, #300
...
###############################################################################
    ...
    if STEPS[STEP]['Execute']==True:
        ...
        max_volume_allowed = 175 # Tips allow up to 200uL, but we only allow max_volume_allowed
    ...
    if STEPS[STEP]['Execute']==True:
        ...
        for i in range(num_cols):
            ...
            for transfer_vol in elution_vol:
                ...
                pickup_height = pickup_height, rinse = False, wait_time = 2, blow_out = True)
